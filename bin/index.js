...
var main = function() {
    var _ref = _asyncToGenerator(function() {
        var args, _args_targets, directusURL, directusToken, directus, types;
        return __generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    _args_targets = _slicedToArray(args.targets, 2), directusURL = _args_targets[0], directusToken = _args_targets[1];
                    if (!directusURL) {
...
main(); // const directus = new Directus(
 // 	"http://localhost:8055",
