...
var Directus = /*#__PURE__*/ function() {
                ...
                switch(_state.label){
                    ...
                    case 3:
                        ...
                        relations.forEach(function(relation) {
                            var _relation_meta, _this_collectionsMap_, _relation_meta1, _this_collectionsMap_1;
                    ...
                    case 1:
                        ...
                        Object.values(collections).forEach(function(collection) {
                            ...
                            collection.fields.forEach(function(field) {
                                var _field_meta, _field_meta_interface, _field_schema;
    ...
    _proto.generateFile = function generateFile() {
        var useIntersectionTypes = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false, path = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "./directus-types.ts";
        var _this = this;
        return _asyncToGenerator(function() {
            var types;
            return __generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        return [
                            4,
                            _this.generate(useIntersectionTypes)
                        ];
                    case 1:
                        types = _state.sent();
